...
_TEMPLATE_CONTRACTS = (
    ...
    "May also include 1 to 3 sequential multiply/divide steps applied to that running total "
    "(e.g. a grouped amount doubled, then split into smaller equal groups) as long as every "
    "intermediate amount divides evenly for exact division.\n"
