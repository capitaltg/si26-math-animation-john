...
@pytest.mark.parametrize(
    ...
    [
        ...
        (RangePredicate(value=FieldRefNode(field="a"), minimum=LiteralNode(value=1), maximum=LiteralNode(value=5)), {"a": 0}, False),
        (EqualsPredicate(left=FieldRefNode(field="a"), right=LiteralNode(value=4)), {"a": 4}, True),
        (EqualsPredicate(left=FieldRefNode(field="a"), right=LiteralNode(value=4)), {"a": 5}, False),
        (NotEqualsPredicate(left=FieldRefNode(field="a"), right=LiteralNode(value=4)), {"a": 4}, False),
        (NotEqualsPredicate(left=FieldRefNode(field="a"), right=LiteralNode(value=4)), {"a": 5}, True),
